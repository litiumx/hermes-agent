...
COMPLEXITY_MARKERS = [
    ...
    (r"(?i)(баг|ошибк[аи]|не\s+работает|сломано|исправь|почини|debug|отлад)", Effort.PRO, "debug_request"),
    (r"(?i)(аудировать|проверь\s+безопасность|security\s+(audit|review)|vulnerability)", Effort.PRO_MAX, "security_audit"),
